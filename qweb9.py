...
def main():
    ...
    # Our queries should discover that there are '16.83 million books'
    # and '5.571 million articles'.
    ...
    # Interestingly, neither Wolfram Alpha, Alexa, Cortana?, Google, or Siri
    # can answer this simple comparative question.
